...
export const ITEM_BASES: Record<string, ItemBase> = {
  ...
  rusty_axe: B({ kind: 'weapon', slot: 'weapon', name: 'Rusty Axe', icon: '🪓', tier: 1, weaponKind: 'axe', damageDice: '1d8', damageType: 'slashing', value: 22, twoHanded: true, desc: 'Mostly rust, technically an axe. Two hands, one swing, zero regrets.' }),

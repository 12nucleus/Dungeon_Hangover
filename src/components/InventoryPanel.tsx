...
const SLOT_ICON: Record<string, string> = {
  ...
  weapon: '⚔️', offHand: '🛡️', amulet: '📿', ring1: '💍', ring2: '💍', ranged: '🏹', quiver: '🪶',
};

const SLOT_LABEL: Record<string, string> = {
  head: 'Head', chest: 'Chest', legs: 'Legs', boots: 'Boots', gloves: 'Gloves', arms: 'Arms', cloak: 'Cloak', belt: 'Belt', trinket: 'Trinket',
  weapon: 'Main Hand', offHand: 'Off Hand', amulet: 'Amulet', ring1: 'Ring I', ring2: 'Ring II', ranged: 'Ranged', quiver: 'Quiver',
};

const LEFT_SLOTS = ['head', 'chest', 'legs', 'boots', 'cloak', 'belt', 'arms'] as const;
const RIGHT_SLOTS = ['weapon', 'offHand', 'ranged', 'quiver', 'gloves', 'amulet', 'ring1', 'ring2', 'trinket'] as const;
